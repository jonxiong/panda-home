...
【面试记录】
- css3相关：（3.5）
- 页面如何适配（说到rem，vw,vh了解）（3）
- bfc(3.5)
- 对eventLoop的理解(3.5)
- 模块化理解：node-CommonJS，AMD，CMD，ES6（2）
- 对es6熟悉程度(3.5)
- async/await，相比于promise的优势（3）
- http状态码（4）
- 有几种前端储存的方式？追问区别（3.5）
- 如何跨域共享cookie,如何使脚本不能访问cookie（4）
- Vue的生命周期理解，请求一般放在哪个生命周期，在什么阶段才能访问操作DOM（3.5）
- Proxy与Object.definedProperty的优点（3）
- vuex里面的各文件分工（3）
- 如何解决vue渲染白屏问题（3）
- webpack(2.5,了解基本使用)
- 微信小程序：自学了解，如何转义成其他小程序的（2.5）
- 有亮点项目：组件平台，表达清晰，

【总评】
一年工作经验对前端基础知识掌握较好，思维逻辑和表达较为清晰，有一定潜力
